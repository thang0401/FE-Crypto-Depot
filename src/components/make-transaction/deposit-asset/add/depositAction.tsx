...
const DepositActions = ({ toggleSendInvoiceDrawer, toggleAddPaymentDrawer, setWalletPubkey, setTokenData }: Props): JSX.Element => {
  const [account, setAccount] = useState<string | null>(null);
  const [isConnected, setIsConnected] = useState<boolean>(false);

  // Bước 7: Kết nối ví MetaMask
  ...
  return (
    <Card>
      <CardContent>
        ...
        <Button fullWidth sx={{ mb: 4 }} color="secondary" variant="outlined">
          In hoá đơn
        </Button>
      </CardContent>
    </Card>
