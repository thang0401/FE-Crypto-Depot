...
const TERMS = [
  { value: '1M', label: '1 Month - 3.8%', interest: 3.8 },
  { value: '3M', label: '3 Months - 4.0%', interest: 4.0 },
  { value: '6M', label: '6 Months - 4.5%', interest: 4.5 },
  { value: '12M', label: '12 Months - 5.0%', interest: 5.0 },
];
...
const SavingsInterestCalculator: React.FC = () => {
  ...
  const handleOpenSavings = () => {
    ...
    const formattedMaturityDate = format(calculatedResults.maturityDate, 'dd/MM/yyyy');

    // Construct query parameters
    // const queryParams = new URLSearchParams({
    //   amount: calculatedResults.principalAmount.toString(),
    //   currency: currency,
    //   term: term,
    //   startDate: formattedStartDate,
    //   maturityDate: formattedMaturityDate,
    //   interestRate: calculatedResults.interestRate.toString()
    // }).toString();

    // Navigate with query parameters
    // router.push(`/saving/add-saving-asset/open?${queryParams}`);
                    ...
                    <Grid container spacing={3} sx={{ px: 2, pb: 2 }}>
                      ...
                      <Grid item xs={12} sm={4}>
                        <Paper sx={{ p: 2, height: '100%', display: 'flex', alignItems: 'center' }}>
                          <Typography>
                            Interest: {TERMS.find(t => t.value === term)?.interest || '0'}%
                          </Typography>
                        </Paper>
                      </Grid>
                  ...
                  <Grid item xs={12}>
                    <StyledCard>
                      ...
                      <Grid container spacing={2} sx={{ px: 2, pb: 2 }}>
                        <Grid item xs={6}>
                          <Typography sx={{ fontWeight: 'medium' }}>Maturity Date:</Typography>
                        </Grid>
                        <Grid item xs={6}>
                          <Typography>
                        ...
                        <Grid item xs={6}>
                          <Typography sx={{ fontWeight: 'medium' }}>Interest Amount:</Typography>
                        </Grid>
                        <Grid item xs={6}>
                        ...
                        <Grid item xs={6}>
                          <Typography sx={{ fontWeight: 'bold' }}>Total Savings:</Typography>
                        </Grid>
                        <Grid item xs={6}>
