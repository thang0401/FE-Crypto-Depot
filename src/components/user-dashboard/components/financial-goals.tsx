    ...
    <DashboardCard>
      <CardContent>
        <Box sx={{ display: "flex", justifyContent: "space-between", alignItems: "center", mb: 3 }}>
          ...
          <Button color="primary">+ Thêm mục tiêu mới</Button>
        </Box>
            ...
            <Grid item xs={12} md={4} key={index}>
              <GoalCard color={goal.color}>
                ...
                <Box sx={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                  <Typography variant="body2">Đã tiết kiệm: {goal.saved} USDC</Typography>
                  <Typography variant="body2">Mục tiêu: {goal.goal} USDC</Typography>
                </Box>
              </GoalCard>
            </Grid>
          ))}
