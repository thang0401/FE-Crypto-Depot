...
//   const rememberMe = router.query.rememberMe === 'true';
...
//         { otp: data.otp, user_id: userId, rememberMe },
//         (err) => {
...
//     } catch (error: any) {
//       const message = error.message || 'Mã OTP không hợp lệ';
//       setOtpError(message);
//       toast.error(message);
//     }
//   };
...
//               {otpError && <FormHelperText sx={{ color: 'error.main' }}>{otpError}</FormHelperText>}
//             </FormControl>
...
//                 <LinkStyled href='/auth/login'>Back to Login</LinkStyled>
//               </Typography>
//             </Box>
//           </form>
//         </Box>
...
// OtpPage.getLayout = (page: ReactNode) => <BlankLayout>{page}</BlankLayout>;

// OtpPage.guestGuard = false;
// OtpPage.authGuard = true;
